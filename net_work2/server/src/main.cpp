    ...
    while (1)
    {
        ...
        for (int i = 0; i < readNum; ++i)
        {
            ...
            else 
            {
                ...
                //     {
                //         trainState stats;
                //         stats.data_len=sizeof(int);
                //         stats.state=REGISTER;
                //         strcpy(stats.buf,"true");//表示可用
                //         send(netFd, &stats, sizeof(stats.data_len) + stats.data_len+sizeof(stats.state), 0);
